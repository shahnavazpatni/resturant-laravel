...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('/')}}assets/website/css/flexslider.css">
        <link rel="stylesheet" href="{{asset('/')}}assets/website/css/pricing.css">
        <link rel="stylesheet" href="{{asset('/')}}assets/website/css/bootstrap-datetimepicker.min.css">
        <link rel="stylesheet" href="{{asset('/')}}assets/website/css/main.css">
        
        @include('website.includes.slider')

        <script src="{{asset('/')}}assets/website/js/jquery-1.11.2.min.js"></script>
        <script type="text/javascript" src="{{asset('/')}}assets/website/js/jquery.flexslider.min.js"></script>
    ...
    <body data-spy="scroll" data-target="#template-navbar">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">
                        <img id="logo" src="{{asset('/')}}assets/website/images/Logo_main.png" class="logo img-responsive">
                    </a>
                </div>
            ...
            <div class="item">
                <div class="container">
                    <div class="header-content">
                        <h1 class="header-title text-white">{{$slider->title}}</h1>
        ...
        <section id="about" class="about">
            <img src="{{asset('/')}}assets/website/images/icons/about_color.png" class="img-responsive section-icon hidden-sm hidden-xs">
            <div class="wrapper">
                            ...
                            <ul id="menu-pricing" class="menu-price">
                                @foreach ($items as $item)
                                    <li class="item" id="{{ $item->category->slug }}">
                                        <a href="#">
                                            <img src="{{asset('/')}}upload/items/{{$item->image}}" class="img-responsive" alt="{{$item->category->name}}" >
        ...
        <section id="great-place-to-enjoy" class="great-place-to-enjoy">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{asset('/')}}assets/website/images/icons/beer_black.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
        ...
        <section id="beer" class="beer">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{asset('/')}}assets/website/images/icons/beer_color.png">
            <div class="container-fluid">
                <div class="row dis-table">
        ...
        <section id="breakfast" class="breakfast">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{asset('/')}}assets/website/images/icons/bread_black.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
        ...
        <section id="bread" class="bread">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{asset('/')}}assets/website/images/icons/bread_color.png">
            <div class="container-fluid">
                <div class="row dis-table">
                    <div class="hidden-xs col-sm-6 dis-table-cell section-bg">
        ...
        <section id="featured-dish" class="featured-dish">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{asset('/')}}assets/website/images/icons/food_black.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
        ...
        <section id="have-a-look" class="have-a-look hidden-xs">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{asset('/')}}assets/website/images/icons/food_color.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row">
        ...
        <section id="reserve" class="reserve">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{asset('/')}}assets/website/images/icons/reserve_black.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
        ...
        <section class="reservation">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{asset('/')}}assets/website/images/icons/reserve_color.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class=" section-content">
                        <div class="row">
                                ...
                                <form class="reservation-form" method="post" action="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control reserve-form empty iconified" name="date_and_time" id="date_and_time" placeholder="&#xf017;  Time">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 text-center submitting" style="display: none;">
                                            <h3>Submitting...</h3>
                                        </div>
                                        <div class="col-md-12 col-sm-12">
                            ...
                            <form class="contact-form" method="post" action="{{route('send.message')}}">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text name-error text-danger"></small>
                                    </div>
                                    <div class="form-group">
                                        <input name="email" type="email" class="form-control" id="email" placeholder="  Email">
                                        <small class="form-text email-error text-danger"></small>
                                    </div>
                                    <div class="form-group">
                                        <input name="subject" type="text" class="form-control" id="subject" placeholder="  Subject">
                                        <small class="form-text subject-error text-danger"></small>
                                    </div>
                                </div>

                                <div class="col-md-6 col-sm-6">
                                    <textarea name="message" type="text" class="form-control" id="message" rows="7" placeholder="  Message"></textarea>
                                    <small class="form-text message-error text-danger"></small>
                                </div>
                                <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 contact-admin" style="display: none;">
                                    <div class="text-center">
                                        <h3>Submitting...</h3>
                                    </div>
                                </div>
        ...
        <script src="{{asset('/')}}assets/website/js/bootstrap.min.js" type="text/javascript"></script>
        <script src="{{asset('/')}}assets/website/js/owl.carousel.min.js" type="text/javascript"></script>
        <script src="{{asset('/')}}assets/website/js/jquery.mixitup.min.js" type="text/javascript"></script>
        <script src="{{asset('/')}}assets/website/js/wow.min.js" type="text/javascript"></script>
        <script src="{{asset('/')}}assets/website/js/jquery.validate.js" type="text/javascript"></script>
        <script src="{{asset('/')}}assets/website/js/jquery.hoverdir.js" type="text/javascript"></script>
        <script src="{{asset('/')}}assets/website/js/jQuery.scrollSpeed.js" type="text/javascript"></script>
        <script src="{{asset('/')}}assets/website/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
        <script src="{{asset('/')}}assets/website/js/sweetalert.min.js"></script>
        <script src="{{asset('/')}}assets/website/js/script.js" type="text/javascript"></script>
        <script>
            $.ajaxSetup({
                headers: {
            ...
            $(function(){
                ...
                $(document).on('submit', '.contact-form', function(){
                    ...
                    $('form.contact-form .form-control').css('border', '');
                    $('form.contact-form .form-text').text('');
                    ...
                    $.ajax({
                        ...
                        dataType: 'JSON',
                        beforeSend: function(){
                            $(".contact-admin").css('display', 'block');
                        },
                        success: function(data){
                            if(data.message){
                                swal(data.message, {
                        ...
                        complete: function(){
                            $(".contact-admin").css('display', 'none');
                        }
                    });
